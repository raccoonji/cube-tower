...
public class GameController : MonoBehaviour
{
    ...
    private void Start() {
        ...
        scoreTxt.text = "<size=35><color=#BC0C00>best:</color></size> " + PlayerPrefs.GetInt("score") + "\n<size=30>now:</size> 0";
        toCameraColor = Camera.main.backgroundColor;
        mainCam = Camera.main.transform;
        camMoveToYPosition = 4.9f + nowCube.y - 1f;
...
//цвет при постройке у, дописать на реализации магазина
